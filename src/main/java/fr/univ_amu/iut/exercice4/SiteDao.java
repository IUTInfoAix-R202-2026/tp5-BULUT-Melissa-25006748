...
public class SiteDao {
  ...
  public void insert(Site site) {
    ...
    try (Connection connexion = source.getConnection();
      ...
      throw new DataAccessException("Erreur lors de l'insertion du site " + site.numeroCarre(), e);
    }
  }
  ...
  public void update(Site site) {
    ...
    try (Connection connexion = source.getConnection();
      ...
      throw new DataAccessException(
          "Erreur lors de la mise à jour du site " + site.numeroCarre(), e);
    }
  }
  ...
  public void delete(String numeroCarre) {
    ...
    try (Connection connexion = source.getConnection();
      ...
      throw new DataAccessException("Erreur lors de la suppression du site " + numeroCarre, e);
    }
  }
